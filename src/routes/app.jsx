...
const appRoutes = [
    { path: "/dashboard", name: "Home", icon: "pe-7s-graph", component: Dashboard },
    { path: "/user", name: "Register", icon: "pe-7s-user", component: UserProfile },
    { path: "/table", name: "Make Trip", icon: "pe-7s-note2", component: TableList },
